...
(function() {
  var cheerio, extract, fetch, gatherer, languages, load, merge, pagination;
  ...
  extract = function(html) {
    var $;
    $ = load(html);
    return $('tr.cardItem').toArray().map(cheerio).map(function($tr) {
      var $name, code, id, language, name, trans_card_name, _ref;
      _ref = $tr.children(), trans_card_name = _ref[0], language = _ref[1];
