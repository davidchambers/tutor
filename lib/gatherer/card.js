(function() {
  ...
  module.exports.url = function(path, _arg) {
    var id, name;
    id = _arg.id, name = _arg.name;
    return ("http://gatherer.wizards.com/Pages/Card/" + path) + ((id != null) && (name != null) ? "?multiverseid=" + id + "&part=" + (encodeURIComponent(name)) : id != null ? "?multiverseid=" + id : "?name=" + (encodeURIComponent(name)));
  };
