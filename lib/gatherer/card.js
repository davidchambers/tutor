...
(function() {
  ...
  extract = function(html, details) {
    var $, card, d, date, el, encodedName, get_versions, m, rating, ruling, set, t, t1, verbose, votes, y, _i, _j, _len, _ref, _ref1, _ref2, _ref3;
    ...
    $('.label').each(function() {
      var $el, $flavor, match, pattern, power, subtypes, text, toughness, type, types, _j, _k, _l, _len1, _ref3, _ref4, _ref5;
      switch (t(this)) {
        case 'Card Name:':
        ...
        case 'Types:':
          _ref3 = /^(.+?)(?:\s+\u2014\s+(.+))?$/.exec(t1(this)), _j = _ref3.length - 2, types = _ref3[_j++], subtypes = _ref3[_j++];
          _ref4 = types.split(/\s+/);
        ...
        case 'P/T:':
          _ref5 = /^(.+?)\s+\/\s+(.+)$/.exec(t1(this)), _l = _ref5.length - 2, power = _ref5[_l++], toughness = _ref5[_l++];
    ...
    _ref3 = /^CommunityRating:(\d(?:[.]\d+)?)\/5[(](\d+)votes?[)]$/.exec($('.textRating').text().replace(/\s+/g, '')), _j = _ref3.length - 2, rating = _ref3[_j++], votes = _ref3[_j++];
