...
(function() {
  ...
  module.exports = function(details, callback) {
    ...
    gatherer.request('Pages/Card/Details.aspx', query, function(err, body) {
      if (err) {
        return callback(err);
      } else {
  ...
  module.exports.query = function(details) {
    var id, name, page, query;

    query = {};
    id = details.id, name = details.name, page = details.page;
    if (id) {
