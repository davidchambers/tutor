...
(function() {
  ...
  module.exports = function(name, callback) {
    ...
    url = 'http://gatherer.wizards.com/Pages/Search/Default.aspx' + ("?output=spoiler&special=true&set=[%22" + (encodeURIComponent(name)) + "%22]");
    request({
      url: url
  ...
  extract = function(html, name) {
    ...
    cards = [];
    card = null;
    $('#ctl00_ctl00_ctl00_MainContent_SubContent_SubContent_searchResultsContainer').find('tr').each(function() {
      var first, key, origin, param, pattern, power, rarity, second, subtypes, toughness, type, types, val, version, words, _base, _i, _j, _len, _len1, _name, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      ...
      switch (key) {
        ...
        case 'Set/Rarity:':
          ...
          for (_j = 0, _len1 = _ref4.length; _j < _len1; _j++) {
            ...
            ((_ref5 = (_base = card.versions)[_name = words.join(' ')]) != null ? _ref5 : _base[_name] = []).push(rarity);
          }
          return _ref6 = card.versions[name], card.rarity = _ref6[0], _ref6;
      }
    });
    cards.push(card);
    return cards;
