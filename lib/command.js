...
(function() {
  ...
  ['formats', 'sets', 'types'].forEach(function(resource) {
    return program.command(resource).option('-f, --format [formatter]', '"json" or "summary"', 'summary').action(function(options) {
      return tutor[resource](formatters[resource][options.format]);
    });
  });
