...
(function() {
  var collect_options, entities, extract, gatherer, identity, load, name, querystring, request, symbols, to_symbol, _i, _len, _ref;
  ...
  gatherer.url = function(url, query) {
    var key, sorted, _i, _len, _ref;

    sorted = {};
    _ref = Object.keys(query).sort();
  ...
  collect_options = function(label) {
    return function(callback) {
      gatherer.request('/Pages/Default.aspx', function(err, body) {
        var formats;
  ...
  gatherer.request = function(url, cb) {
    var options;
